---
title: "Maven 核心概念总结"
source: "https://javaguide.cn/tools/maven/maven-core-concepts.html"
author:
  - "[[Guide]]"
published: 2026-06-11
created: 2026-07-06
description: "Apache Maven 的本质是一个软件项目管理和理解工具。基于项目对象模型 (Project Object Model，POM) 的概念，Maven 可以从一条中心信息管理项目的构建、报告和文档。重点围绕 Maven 介绍、Maven 坐标、Maven 依赖、Maven 仓库 等内容展开。"
tags:
  - "clippings"
---
...
- Introduction to the Build Lifecycle - Maven 官方文档： [https://maven.apache.org/guides/introduction/introduction-to-the-lifecycle.html#Lifecycle\_Reference](https://maven.apache.org/guides/introduction/introduction-to-the-lifecycle.html#Lifecycle_Reference)
- Maven 依赖范围： [https://www.mvnbook.com/maven-dependency.html](https://www.mvnbook.com/maven-dependency.html)
