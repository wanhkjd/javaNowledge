...
created: 2026-07-06
description: "MongoDB常见面试题总结下篇，深入讲解MongoDB各类索引（单字段、复合、多键、文本、地理位置、TTL）的原理、使用场景和查询优化技巧。重点围绕 MongoDB 索引、MongoDB 高可用、学习资料推荐、参考、NoSQL 等内容展开。结合 JavaGuide 知识体系梳理 数据库 / Mongodb / Mo。"
tags:
  - "clippings"
---
## MongoDB 索引
