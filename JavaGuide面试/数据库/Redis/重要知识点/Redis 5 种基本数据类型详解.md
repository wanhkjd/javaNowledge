...
source: "https://javaguide.cn/database/redis/redis-data-structures-01.html"
author:
  - "[[Guide]]"
published: 2026-06-12
created: 2026-07-06
description: "详解Redis五种基本数据类型String、List、Set、Hash、Zset的使用方法和应用场景，深入分析SDS、跳表、压缩列表等底层数据结构实现原理。重点围绕 String（字符串）、List（列表）、Hash（哈希）、Set（集合）、Redis 等内容展开。结合 JavaGuide 知识体系梳理 数据库 / 。"
tags:
  - "clippings"
---
...
- [线性数据结构详解](https://javaguide.cn/cs-basics/data-structure/linear-data-structure.html) ：理解 List、队列和链表的关系。
- [哈希表面试题总结](https://javaguide.cn/cs-basics/data-structure/hash-table.html) ：理解 Hash、Set 这类结构的查找和冲突处理。
- [跳表面试题总结](https://javaguide.cn/cs-basics/data-structure/skip-list.html) ：理解 Sorted Set 范围查询和排名能力背后的结构取舍。
