---
title: "Redis常见阻塞原因总结"
source: "https://javaguide.cn/database/redis/redis-common-blocking-problems-summary.html"
author:
  - "[[Guide]]"
published: 2026-05-25
created: 2026-07-06
description: "全面总结Redis常见的阻塞原因，包括O(n)复杂度命令、bigkey操作、AOF日志刷盘、RDB快照创建、主从同步等场景，帮助你排查和预防Redis性能问题。重点围绕 O(n) 命令、SAVE 创建 RDB 快照、AOF、大 Key、Redis 等内容展开。结合 JavaGuide 知识体系梳理 数据库 / Red。"
tags:
  - "clippings"
---
> 本文整理完善自： [https://mp.weixin.qq.com/s/0Nqfq\_eQrUb12QH6eBbHXA](https://mp.weixin.qq.com/s/0Nqfq_eQrUb12QH6eBbHXA) ，作者：阿 Q 说代码
...
- - redis-rdb-tools：Python 语言写的用来分析 Redis 的 RDB 快照文件用的工具
		- rdb\_bigkeys：Go 语言写的用来分析 Redis 的 RDB 快照文件用的工具，性能更好。
