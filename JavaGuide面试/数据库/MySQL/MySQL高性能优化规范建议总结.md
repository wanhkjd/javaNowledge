...
source: "https://javaguide.cn/database/mysql/mysql-high-performance-optimization-specification-recommendations.html"
author:
  - "[[Guide]]"
published: 2026-05-18
created: 2026-07-06
description: "MySQL高性能优化规范建议总结，涵盖数据库命名规范、表设计规范、字段设计规范、索引设计规范、SQL编写规范等，帮助你构建高效稳定的数据库系统。重点围绕 数据库命名规范、数据库基本设计规范、数据库字段设计规范、索引设计规范、MySQL 等内容展开。结合 JavaGuide 知识体系梳理 数据库 / MySQL / M。"
tags:
  - "clippings"
---
...
对于 MySQL 来说，是存在关联缓存的，缓存的大小可以由 join\_buffer\_size 参数进行设置。

在 MySQL 中，对于同一个 SQL 多关联（join）一个表，就会多分配一个关联缓存，如果在一个 SQL 中关联的表越多，所占用的内存也就越大。

如果程序中大量地使用了多表关联的操作，同时 join\_buffer\_size 设置得也不合理，就容易造成服务器内存溢出的情况，就会影响到服务器数据库性能的稳定性。
