...
source: "https://javaguide.cn/database/character-set.html"
author:
  - "[[Guide]]"
published: 2026-05-21
created: 2026-07-06
description: "详解字符集与字符编码原理，深入分析ASCII、GB2312、GBK、UTF-8、UTF-16等常见编码，解释MySQL中utf8与utf8mb4的区别以及emoji存储问题的解决方案。重点围绕 字符集是什么？、字符编码是什么？、有哪些常见的字符集？、MySQL 字符集、数据库基础 等内容展开。"
tags:
  - "clippings"
---
...
- GB2312-维基百科： [https://zh.wikipedia.org/wiki/GB\_2312](https://zh.wikipedia.org/wiki/GB_2312)
- UTF-8-维基百科： [https://zh.wikipedia.org/wiki/UTF-8](https://zh.wikipedia.org/wiki/UTF-8)
- GB18030-维基百科: [https://zh.wikipedia.org/wiki/GB\_18030](https://zh.wikipedia.org/wiki/GB_18030)
