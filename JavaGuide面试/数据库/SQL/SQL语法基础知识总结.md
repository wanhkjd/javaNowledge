---
title: "SQL语法基础知识总结"
source: "https://javaguide.cn/database/sql/sql-syntax-summary.html"
author:
  - "[[Guide]]"
published: 2026-05-18
created: 2026-07-06
description: "SQL语法基础知识总结，系统讲解DDL数据定义、DML数据操作、DQL数据查询、DCL数据控制语言，涵盖表操作、约束、索引、事务、连接查询等核心知识点。重点围绕 基本概念、增删改查、排序、分组、数据库基础 等内容展开。结合 JavaGuide 知识体系梳理 数据库 / SQL / Sql Syntax Summary。"
tags:
  - "clippings"
---
> 本文整理完善自下面这两份资料：
