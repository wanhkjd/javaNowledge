---
title: "Java 线程池详解"
source: "https://javaguide.cn/java/concurrent/java-thread-pool-summary.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "Java线程池详解：深入讲解ThreadPoolExecutor核心参数配置、Executor框架体系、任务队列选择、拒绝策略、线程池工作原理及最佳实践。重点围绕 线程池介绍、Executor 框架介绍、ThreadPoolExecutor 类介绍（重要）、线程池原理分析（重要）、Java并发 等内容展开。"
tags:
  - "clippings"
---
