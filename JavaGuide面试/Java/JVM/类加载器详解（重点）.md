---
title: "类加载器详解（重点）"
source: "https://javaguide.cn/java/jvm/classloader.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "Java类加载器详解：深入剖析ClassLoader类加载机制、双亲委派模型原理、启动类加载器/扩展类加载器/应用类加载器、自定义类加载器实现、打破双亲委派场景。重点围绕 回顾一下类加载过程、类加载器、双亲委派模型、推荐阅读、JVM 等内容展开。结合 JavaGuide 知识体系梳理 Java / JVM / Cla。"
tags:
  - "clippings"
---
## 回顾一下类加载过程
