---
title: "Java内存区域详解（重点）"
source: "https://javaguide.cn/java/jvm/memory-area.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "JVM内存区域详解：深入剖析Java运行时数据区（堆、方法区、虚拟机栈、本地方法栈、程序计数器）、对象创建过程、内存分配策略、对象访问定位方式。重点围绕 前言、运行时数据区域、HotSpot 虚拟机对象探秘、参考、JVM 等内容展开。结合 JavaGuide 知识体系梳理 Java / JVM / Memory Ar。"
tags:
  - "clippings"
---
