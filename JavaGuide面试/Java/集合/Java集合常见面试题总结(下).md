...
source: "https://javaguide.cn/java/collection/java-collection-questions-02.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "Java集合高频面试题：深入分析HashMap底层原理、红黑树转换、哈希冲突解决、ConcurrentHashMap线程安全机制、与Hashtable区别等核心知识点。重点围绕 Map（重要）、Collections 工具类（不重要）、写在最后、Java集合 等内容展开。结合 JavaGuide 知识体系梳理 Jav。"
tags:
  - "clippings"
---
