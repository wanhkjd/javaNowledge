...
source: "https://javaguide.cn/java/io/io-basis.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "Java IO基础知识全面总结：详解字节流与字符流区别、InputStream/OutputStream字节流、Reader/Writer字符流、缓冲流优化、文件读写操作。重点围绕 IO 流简介、字节流、字符流、字节缓冲流、Java IO 等内容展开。结合 JavaGuide 知识体系梳理 Java / Java I。"
tags:
  - "clippings"
---
## IO 流简介
