...
source: "https://javaguide.cn/java/io/io-design-patterns.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "Java IO设计模式深度解析：详解装饰器模式在BufferedInputStream中应用、适配器模式InputStreamReader实现、模板方法模式InputStream设计，理解Java IO类库架构。重点围绕 装饰器模式、适配器模式、工厂模式、观察者模式、Java IO 等内容展开。"
tags:
  - "clippings"
---
