...
created: 2026-07-06
description: "详解Java为什么只有值传递：通过示例深入分析Java参数传递机制，澄清值传递与引用传递的常见误区，理解形参实参本质区别。重点围绕 形参&实参、值传递&引用传递、为什么 Java 只有值传递？、引用传递是怎么样的？、Java基础 等内容展开。结合 JavaGuide 知识体系梳理 Java / 基础知识 / Why 。"
tags:
  - "clippings"
---
开始之前，我们先来搞懂下面这两个概念：
