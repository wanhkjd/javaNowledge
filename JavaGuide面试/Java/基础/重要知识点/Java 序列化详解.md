---
title: "Java 序列化详解"
source: "https://javaguide.cn/java/basis/serialization.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "深入解析Java序列化与反序列化机制：详解Serializable接口、transient关键字、serialVersionUID作用、序列化协议选择及RPC、缓存等应用场景。重点围绕 什么是序列化和反序列化？、常见序列化协议有哪些？、写在最后、Java基础 等内容展开。结合 JavaGuide 知识体系梳理 Jav。"
tags:
  - "clippings"
---
## 什么是序列化和反序列化？
