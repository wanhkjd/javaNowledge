...
source: "https://javaguide.cn/high-availability/high-availability-interview-questions.html"
author:
  - "[[Guide]]"
published: 2026-05-26
created: 2026-07-06
description: "高可用系统设计面试复习路线，串联 SLA、单点故障、限流降级熔断、超时重试、接口幂等、冗余容灾、性能压测和故障演练等 Java 后端高频考点。重点围绕 高可用面试先建立故障视角、第一阶段：高可用系统设计总览、第二阶段：限流、降级和熔断、第三阶段：超时、重试和幂等、高可用 等内容展开。结合 JavaGuide 知识体系。"
tags:
  - "clippings"
---
...
- [性能测试详解](https://javaguide.cn/high-availability/performance-test.html)
...
- [限流算法详解](https://javaguide.cn/high-availability/limit-request.html)
- [服务降级和熔断详解](https://javaguide.cn/high-availability/fallback-and-circuit-breaker.html)
...
- [超时和重试机制详解](https://javaguide.cn/high-availability/timeout-and-retry.html)
- [接口幂等性详解](https://javaguide.cn/high-availability/idempotency.html)
...
1. 先看 [高可用系统设计指南](https://javaguide.cn/high-availability/high-availability-system-design.html) ，建立整体框架。
2. 再看 [限流算法详解](https://javaguide.cn/high-availability/limit-request.html) 、 [服务降级和熔断详解](https://javaguide.cn/high-availability/fallback-and-circuit-breaker.html) 。
3. 然后看 [超时和重试机制详解](https://javaguide.cn/high-availability/timeout-and-retry.html) 、 [接口幂等性详解](https://javaguide.cn/high-availability/idempotency.html) 。
4. 最后补 [冗余设计详解](https://javaguide.cn/high-availability/redundancy.html) 、 [性能测试详解](https://javaguide.cn/high-availability/performance-test.html) 。
