...
source: "https://javaguide.cn/high-availability/performance-test.html"
author:
  - "[[Guide]]"
published: 2026-06-29
created: 2026-07-06
description: "性能测试入门指南，讲解 RPS、QPS、TPS、RT、P90/P99/P999、Little's Law、容量评估、曲棍球棒曲线、背压与自愈验证，以及负载测试、压力测试、稳定性测试和 JMeter、Gatling、k6、Locust、ab、wrk 等压测工具。重点围绕 不同角色看网站性能、性能测试需要注意的点等核心内。"
tags:
  - "clippings"
---
