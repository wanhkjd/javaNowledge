---
title: "认证授权基础概念详解"
source: "https://javaguide.cn/system-design/security/basis-of-authority-certification.html"
author:
  - "[[Guide]]"
published: 2026-05-18
created: 2026-07-06
description: "认证与授权基础概念详解，讲解Authentication和Authorization的区别、Session、Token、OAuth2等核心知识。重点围绕 认证 (Authentication) 和授权 (Authorization)的区别是什么？、RBAC 模型了解吗？、什么是 Cookie ? Cookie 的作用。"
tags:
  - "clippings"
---
