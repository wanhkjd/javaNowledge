---
title: "代码命名指南"
source: "https://javaguide.cn/system-design/basis/naming.html"
author:
  - "[[Guide]]"
published: 2026-05-18
created: 2026-07-06
description: "代码命名规范指南，涵盖变量、方法、类的命名原则与技巧，提升代码可读性和可维护性。重点围绕 为什么需要重视命名？、常见命名规则以及适用场景、常见命名规范、Codelf:变量命名神器? 等内容展开。结合 JavaGuide 知识体系梳理 系统设计 / 基础知识 / Naming.Html 的核心概念、实践方法等核心内容。"
tags:
  - "clippings"
---
...
**测试方法名、常量、枚举名称需要使用蛇形命名法（snake\_case）**
...
感觉如何？ 相比于使用蛇形命名法（snake\_case）来说是不是不那么易读？
...
**2、测试方法名、常量、枚举名称需要使用蛇形命名法（snake\_case）** ，比如 `should_get_200_status_code_when_request_is_valid` 、 `CLIENT_CONNECT_SERVER_FAILURE` 。并且， **测试方法名称要求全部小写，常量以及枚举名称需要全部大写。**
