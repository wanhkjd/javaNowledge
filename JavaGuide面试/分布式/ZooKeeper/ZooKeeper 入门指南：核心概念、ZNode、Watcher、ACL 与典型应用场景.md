...
source: "https://javaguide.cn/distributed-system/distributed-process-coordination/zookeeper/zookeeper-intro.html"
author:
  - "[[Guide]]"
published: 2026-05-25
created: 2026-07-06
description: "ZooKeeper 入门指南，讲解 ZooKeeper 核心概念、ZNode 数据模型、节点类型、Watcher 监听机制、ACL 权限控制，以及注册中心、分布式锁、配置中心等典型场景。重点围绕 ZooKeeper 介绍、ZooKeeper 重要概念、ZooKeeper 集群、ZAB 协议和 Paxos 算法等核心内。"
tags:
  - "clippings"
---
...
- 谈谈 ZooKeeper 的局限性： [https://wingsxdu.com/posts/database/zookeeper-limitations/](https://wingsxdu.com/posts/database/zookeeper-limitations/)
