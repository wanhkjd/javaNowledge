...
source: "https://javaguide.cn/distributed-system/protocol/raft-algorithm.html"
author:
  - "[[Guide]]"
published: 2026-05-25
created: 2026-07-06
description: "Raft 算法详解，讲解 Leader 选举、日志复制、Leader 追加、日志一致性、安全性约束、成员变更和与 Paxos 的对比，帮助理解分布式一致性协议。重点围绕 1 背景、2 基础概念、3 领导人选举、4 日志复制、分布式协议与算法 等内容展开。结合 JavaGuide 知识体系梳理 分布式系统 / 分布式协。"
tags:
  - "clippings"
---
...
- [https://github.com/OneSizeFitsQuorum/raft-thesis-zh\_cn/blob/master/raft-thesis-zh\_cn.md](https://github.com/OneSizeFitsQuorum/raft-thesis-zh_cn/blob/master/raft-thesis-zh_cn.md)
