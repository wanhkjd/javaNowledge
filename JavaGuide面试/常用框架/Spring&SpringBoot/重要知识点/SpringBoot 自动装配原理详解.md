...
source: "https://javaguide.cn/system-design/framework/spring/spring-boot-auto-assembly-principles.html"
author:
  - "[[Guide]]"
published: 2026-05-18
created: 2026-07-06
description: "SpringBoot自动装配原理深度解析，详解@EnableAutoConfiguration、SpringFactories加载机制及条件注解工作原理。重点围绕 前言、什么是 SpringBoot 自动装配？、SpringBoot 是如何实现自动装配的？、如何实现一个 Starter、SpringBoot 等内容展。"
tags:
  - "clippings"
---
