...
source: "https://javaguide.cn/system-design/framework/spring/spring-design-patterns-summary.html"
author:
  - "[[Guide]]"
published: 2026-05-18
created: 2026-07-06
description: "Spring框架设计模式详解，涵盖工厂模式、代理模式、单例模式、模板方法等在Spring源码中的应用实践。重点围绕 控制反转(IoC)和依赖注入(DI)、工厂设计模式、单例设计模式、代理设计模式、Spring 等内容展开。结合 JavaGuide 知识体系梳理 系统设计 / 开发框架 / Spring / Sprin。"
tags:
  - "clippings"
---
...
- [https://design-patterns.readthedocs.io/zh\_CN/latest/behavioral\_patterns/observer.html](https://design-patterns.readthedocs.io/zh_CN/latest/behavioral_patterns/observer.html)
