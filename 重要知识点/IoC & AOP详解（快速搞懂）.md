...
source: "https://javaguide.cn/system-design/framework/spring/ioc-and-aop.html"
author:
  - "[[Guide]]"
published: 2026-01-16
created: 2026-07-06
description: "Spring IoC与AOP核心原理详解，深入讲解控制反转、依赖注入、切面编程及动态代理的实现机制。重点围绕 IoC （Inversion of control ）、AOP（Aspect oriented programming）、参考、Spring 等内容展开。结合 JavaGuide 知识体系梳理 系统设计 / 。"
tags:
  - "clippings"
---
