...
source: "https://javaguide.cn/database/mysql/mysql-backup-and-restore.html"
author:
  - "[[Guide]]"
published: 2026-06-25
created: 2026-07-06
description: "MySQL备份与恢复详解，讲解 mysqldump、MySQL Shell、Percona XtraBackup、binlog、PITR、RTO/RPO、恢复演练和常见备份误区。重点围绕 备份到底解决什么问题？、RTO 和 RPO 决定备份策略、备份方式有哪些？、用 mysqldump 做逻辑备份等核心内容。"
tags:
  - "clippings"
---
