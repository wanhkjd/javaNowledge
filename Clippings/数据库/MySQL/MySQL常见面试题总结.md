---
title: "MySQL常见面试题总结"
source: "https://javaguide.cn/database/mysql/mysql-questions-01.html"
author:
  - "[[Guide]]"
published: 2026-05-25
created: 2026-07-06
description: "MySQL高频面试题精讲：基础架构、InnoDB引擎、索引原理、B+树、事务ACID、MVCC、redo/undo/binlog日志、行锁/表锁、慢查询优化，一文速通大厂必考点！重点围绕 MySQL 基础、MySQL 字段类型、MySQL 基础架构、MySQL 存储引擎、MySQL 等内容展开。"
tags:
  - "clippings"
---
## MySQL 基础
...
| innodb\_autoinc\_lock\_mode | 介绍 |
| --- | --- |
| 0 | 传统模式 |
