---
title: "SQL常见面试题总结（5）"
source: "https://javaguide.cn/database/sql/sql-questions-05.html"
author:
  - "[[Guide]]"
published: 2026-05-18
created: 2026-07-06
description: "SQL常见面试题总结第五篇，详解NULL空值处理技巧，包括IFNULL、COALESCE函数，以及使用CASE WHEN进行条件统计和完成率计算。重点围绕 空值处理、高级条件语句、限量查询、文本转换函数、数据库基础 等内容展开。结合 JavaGuide 知识体系梳理 数据库 / SQL / Sql Questions。"
tags:
  - "clippings"
---
...
请统计有未完成状态的试卷的未完成数 incomplete\_cnt 和未完成率 incomplete\_rate。由示例数据结果输出如下：

| exam\_id | incomplete\_cnt | complete\_rate |
| --- | --- | --- |
| 9001 | 1 | 0.333 |
...
| uid | avg\_score | avg\_time\_took |
| --- | --- | --- |
| 1001 | 33 | 36.7 |
...
| uid | incomplete\_cnt | incomplete\_rate |
| --- | --- | --- |
| 1004 | 0 | 0.000 |
| 1003 | 1 | 0.500 |
| 1001 | 4 | 0.667 |
...
| uid | exam\_id | score | level | score\_grade |
| --- | --- | --- | --- | --- |
| 1001 | 9001 | 80 | 0 | 良 |
| 1001 | 9002 | 75 | 0 | 良 |
| 1001 | 9002 | 60 | 0 | 中 |
...
| uid | level | register\_time | max\_score |
| --- | --- | --- | --- |
...
| exam\_id | tag | difficulty | duration |
| --- | --- | --- | --- |
| 9004 | 算法 | medium | 80 |
