...
source: "https://javaguide.cn/distributed-system/rpc/dubbo.html"
author:
  - "[[Guide]]"
published: 2026-06-25
created: 2026-07-06
description: "Dubbo 高频面试题总结，覆盖 Dubbo 架构原理、服务暴露与引用、SPI 扩展机制、负载均衡、集群容错、服务治理、注册中心和常见生产问题。重点围绕 Dubbo 基础、分布式基础、Dubbo 架构、Dubbo 的负载均衡策略、RPC 等内容展开。结合 JavaGuide 知识体系梳理 分布式系统 / RPC / 。"
tags:
  - "clippings"
---
提示
...
这篇文章默认你已经理解 RPC 的基本调用流程。如果你对动态代理、序列化、网络传输、服务发现这些概念还不熟，建议先看 [RPC 远程过程调用详解](https://javaguide.cn/distributed-system/rpc/rpc-intro.html) 。Dubbo 涉及注册中心、负载均衡、集群容错，这部分也可以和 [ZooKeeper 专题](https://javaguide.cn/distributed-system/distributed-process-coordination/zookeeper/) 放在一起看。
