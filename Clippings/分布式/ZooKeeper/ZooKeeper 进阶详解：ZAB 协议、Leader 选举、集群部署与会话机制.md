...
source: "https://javaguide.cn/distributed-system/distributed-process-coordination/zookeeper/zookeeper-plus.html"
author:
  - "[[Guide]]"
published: 2026-05-25
created: 2026-07-06
description: "ZooKeeper 进阶详解，深入讲解 ZAB 协议、Leader 选举、集群部署策略、奇数节点原则、会话管理、Watcher 机制和与 Eureka、Nacos 等注册中心的对比。重点围绕 什么是 ZooKeeper、一致性问题、一致性协议和算法、引出 ZAB、ZooKeeper 等内容展开。"
tags:
  - "clippings"
---
