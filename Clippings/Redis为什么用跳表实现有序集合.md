...
source: "https://javaguide.cn/database/redis/redis-skiplist.html"
author:
  - "[[Guide]]"
published: 2026-06-12
created: 2026-07-06
description: "深入讲解Redis有序集合Zset为何选择跳表而非红黑树、B+树实现，详解跳表的数据结构原理、时间复杂度分析和Redis源码实现。重点围绕 前言、跳表在 Redis 中的运用、手写一个跳表、和其余三种数据结构的比较、Redis 等内容展开。结合 JavaGuide 知识体系梳理 数据库 / Redis / Redis。"
tags:
  - "clippings"
---
## 前言
...
如果你只是想先快速了解跳表的多级索引、查询复杂度和面试回答框架，可以先看 [跳表面试题总结](https://javaguide.cn/cs-basics/data-structure/skip-list.html) ，再回到本文看 Redis ZSet 的源码实现。
...
如果想从面试角度快速复盘跳表，可以看 [跳表面试题总结](https://javaguide.cn/cs-basics/data-structure/skip-list.html) 。如果想对比 Redis ZSet 背后的其他结构，也可以顺手复习 [红黑树详解](https://javaguide.cn/cs-basics/data-structure/red-black-tree.html) 和 [哈希表面试题总结](https://javaguide.cn/cs-basics/data-structure/hash-table.html) 。
...
- Redis 对象与底层数据结构详解:[https://blog.csdn.net/shark\_chili3007/article/details/104171986](https://blog.csdn.net/shark_chili3007/article/details/104171986)
