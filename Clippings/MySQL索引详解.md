---
title: "MySQL索引详解"
source: "https://javaguide.cn/database/mysql/mysql-index.html"
author:
  - "[[Guide]]"
published: 2026-06-12
created: 2026-07-06
description: "MySQL索引详解，深入剖析B+树索引结构、聚簇索引与二级索引的区别、联合索引与最左前缀原则、覆盖索引与索引下推优化，以及常见的索引失效场景。重点围绕 索引介绍、索引的优缺点、索引底层数据结构选型、索引类型总结、MySQL 等内容展开。结合 JavaGuide 知识体系梳理 数据库 / MySQL / Mysql I。"
tags:
  - "clippings"
---
...
关于二叉搜索树、AVL 树、红黑树、B 树和 B+ 树的基础对比，可以先看 [树结构详解](https://javaguide.cn/cs-basics/data-structure/tree.html) 和 [红黑树详解](https://javaguide.cn/cs-basics/data-structure/red-black-tree.html) 。
...
如果只想从数据结构角度快速复盘 B 树和 B+ 树，可以回到 [树结构详解](https://javaguide.cn/cs-basics/data-structure/tree.html) 的面试复盘部分。
...
2. 适用于执行计划是 range、ref、eq\_ref、ref\_or\_null 的范围查询。
...
- [树结构详解](https://javaguide.cn/cs-basics/data-structure/tree.html) ：对比二叉搜索树、AVL、红黑树、B 树和 B+ 树。
- [红黑树详解](https://javaguide.cn/cs-basics/data-structure/red-black-tree.html) ：理解内存中自平衡搜索树的取舍，再对比 B+ 树为什么更适合磁盘索引。
