...
source: "https://javaguide.cn/java/collection/java-collection-questions-01.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "Java集合框架面试题总结：深入解析Collection/List/Set/Queue接口，对比ArrayList/LinkedList/HashMap等常用集合类，掌握集合底层数据结构与使用场景。重点围绕 集合概述、List、Set、Queue、Java集合 等内容展开。结合 JavaGuide 知识体系梳理 Ja。"
tags:
  - "clippings"
---
## 集合概述
...
如果想先补堆和 Top K 的算法模板，可以看 [堆详解](https://javaguide.cn/cs-basics/data-structure/heap.html) 和 [Top K 问题面试题总结](https://javaguide.cn/cs-basics/algorithms/top-k.html) 。
...
- [线性数据结构详解](https://javaguide.cn/cs-basics/data-structure/linear-data-structure.html) ：理解数组、链表、栈、队列和 `ArrayList` 、 `LinkedList` 、 `ArrayDeque` 的关系。
- [哈希表面试题总结](https://javaguide.cn/cs-basics/data-structure/hash-table.html) ：理解哈希冲突、扩容和 `HashMap` 的底层思想。
- [红黑树详解](https://javaguide.cn/cs-basics/data-structure/red-black-tree.html) ：理解 `TreeMap` 、 `TreeSet` 以及 `HashMap` 树化链表时涉及的红黑树。
- [堆详解](https://javaguide.cn/cs-basics/data-structure/heap.html) ：理解 `PriorityQueue` 的底层结构和 Top K 题型。
