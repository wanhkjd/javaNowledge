...
source: "https://javaguide.cn/database/nosql.html"
author:
  - "[[Guide]]"
published: 2026-05-21
created: 2026-07-06
description: "NoSQL数据库基础面试题和知识总结，包括NoSQL与SQL的区别、NoSQL的优势、四种NoSQL数据库类型（键值、文档、图形、宽列）及其代表产品Redis、MongoDB、Neo4j等的应用场景。重点围绕 NoSQL 是什么？、SQL 和 NoSQL 有什么区别？、NoSQL 数据库有什么优势？"
tags:
  - "clippings"
---
## NoSQL 是什么？
