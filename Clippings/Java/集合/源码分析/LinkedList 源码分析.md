...
source: "https://javaguide.cn/java/collection/linkedlist-source-code.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "LinkedList源码深度解析：剖析双向链表结构、Deque接口实现、头尾插入删除O(1)时间复杂度、与ArrayList性能对比及适用场景。重点围绕 LinkedList 简介、LinkedList 源码分析、LinkedList 常用方法测试、写在最后、Java集合 等内容展开。结合 JavaGuide 知识体。"
tags:
  - "clippings"
---
