---
title: "泛型&通配符详解"
source: "https://javaguide.cn/java/basis/generics-and-wildcards.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "全面解析Java泛型与通配符：深入理解类型擦除机制、上界下界通配符用法、PECS原则应用，掌握泛型编程核心技巧。重点围绕 泛型、通配符、参考、Java基础 等内容展开。结合 JavaGuide 知识体系梳理 Java / 基础知识 / Generics And Wildcards.Html 的核心概念、实践方法等核心。"
tags:
  - "clippings"
---
## 泛型
