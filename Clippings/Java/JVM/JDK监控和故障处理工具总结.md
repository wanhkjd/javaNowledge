...
source: "https://javaguide.cn/java/jvm/jdk-monitoring-and-troubleshooting-tools.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "汇总 JDK 常用监控与排错工具及使用示例，辅助定位与分析 JVM 问题。重点围绕 JDK 命令行工具、JDK 可视化分析工具、写在最后、JVM 等内容展开。结合 JavaGuide 知识体系梳理 Java / JVM / Jdk Monitoring And Troubleshooting Tools.Html 的。"
tags:
  - "clippings"
---
## JDK 命令行工具
...
C:\Users\SnailClimb>jps -l
 firstNettyDemo.NettyClient2
17396
 org.jetbrains.jps.cmdline.Launcher
 sun.tools.jps.Jps
 firstNettyDemo.NettyServer
```
