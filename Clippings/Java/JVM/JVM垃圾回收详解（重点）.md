---
title: "JVM垃圾回收详解（重点）"
source: "https://javaguide.cn/java/jvm/jvm-garbage-collection.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "JVM垃圾回收详解：全面讲解GC算法（标记清除、复制、标记整理）、分代回收机制、常用垃圾回收器（Serial、Parallel、CMS、G1、ZGC）、GC调优实践。重点围绕 前言、堆空间的基本结构、内存分配和回收原则、死亡对象判断方法、JVM 等内容展开。结合 JavaGuide 知识体系梳理 Java / JVM。"
tags:
  - "clippings"
---
