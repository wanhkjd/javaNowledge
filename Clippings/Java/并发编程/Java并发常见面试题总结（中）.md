...
created: 2026-07-06
description: "Java并发进阶面试题：深入解析synchronized与ReentrantLock区别、volatile可见性保证、JMM内存模型、happens-before原则等并发编程核心机制。重点围绕 ⭐️ JMM（Java 内存模型）、⭐️ volatile 关键字、⭐️ 乐观锁和悲观锁、synchronized 关键字。"
tags:
  - "clippings"
---
