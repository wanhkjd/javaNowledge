...
source: "https://javaguide.cn/java/concurrent/java-concurrent-questions-01.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "Java并发编程基础面试题：深入讲解线程与进程区别、多线程创建方式、线程生命周期状态、死锁四个条件及预防、并发与并行概念等核心知识。重点围绕 线程、多线程、⭐️ 死锁、写在最后、Java并发 等内容展开。结合 JavaGuide 知识体系梳理 Java / Java 并发 / Java Concurrent Ques。"
tags:
  - "clippings"
---
## 线程
