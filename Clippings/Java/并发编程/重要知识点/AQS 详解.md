---
title: "AQS 详解"
source: "https://javaguide.cn/java/concurrent/aqs.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "AQS抽象队列同步器深度解析：详解AQS核心原理、CLH队列结构、独占锁与共享锁实现、ReentrantLock/Semaphore等同步器应用、线程阻塞唤醒机制。重点围绕 AQS 介绍、AQS 原理、常见同步工具类、参考、Java并发 等内容展开。结合 JavaGuide 知识体系梳理 Java / Java 并发。"
tags:
  - "clippings"
---
## AQS 介绍
