...
source: "https://javaguide.cn/java/concurrent/jmm.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "深入解析Java内存模型JMM：详解CPU缓存模型、指令重排序机制、happens-before原则、内存可见性保证，理解多线程并发编程的底层规范。重点围绕 从 CPU 缓存模型说起、指令重排序、JMM(Java Memory Model)、再看并发编程三个重要特性、Java并发 等内容展开。"
tags:
  - "clippings"
---
