---
title: "Java 语法糖详解"
source: "https://javaguide.cn/java/basis/syntactic-sugar.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "深入剖析Java语法糖原理：详解自动装箱拆箱、泛型擦除、增强for、可变参数、枚举、Lambda等语法糖的编译期实现机制，避免使用误区。重点围绕 什么是语法糖？、Java 中有哪些常见的语法糖？、可能遇到的坑、总结、Java基础 等内容展开。结合 JavaGuide 知识体系梳理 Java / 基础知识 / Synt。"
tags:
  - "clippings"
---
> 作者：Hollis
