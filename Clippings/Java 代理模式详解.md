---
title: "Java 代理模式详解"
source: "https://javaguide.cn/java/basis/proxy.html"
author:
  - "[[Guide]]"
published: 2026-06-15
created: 2026-07-06
description: "详解Java代理模式原理与实现：对比静态代理与动态代理差异，深入分析JDK动态代理和CGLIB代理机制，理解AOP横切关注点实现。重点围绕 1. 代理模式、2. 静态代理、3. 动态代理、4. 静态代理和动态代理的对比、Java基础 等内容展开。结合 JavaGuide 知识体系梳理 Java / 基础知识 / Pr。"
tags:
  - "clippings"
---
## 1\. 代理模式
