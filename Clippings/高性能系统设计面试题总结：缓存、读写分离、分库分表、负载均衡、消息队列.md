...
source: "https://javaguide.cn/high-performance/high-performance-interview-questions.html"
author:
  - "[[Guide]]"
published: 2026-06-11
created: 2026-07-06
description: "高性能系统面试题和复习路线汇总，覆盖 CDN、负载均衡、数据库优化、读写分离、分库分表、冷热分离、深度分页、SQL 优化、消息队列、Kafka、RocketMQ、RabbitMQ 等高频考点。重点围绕 高性能系统设计面试怎么准备？、第一阶段：CDN 和负载均衡、第二阶段：数据库性能优化、第三阶段：消息队列与削峰等核心。"
tags:
  - "clippings"
---
