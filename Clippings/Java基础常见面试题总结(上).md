...
created: 2026-06-16
description: "Java基础常见面试题总结：包含Java语言特点、JVM/JDK/JRE区别、字节码详解、基本数据类型、自动装箱拆箱、方法重载与重写等核心知识点，助力Java开发者面试通关。重点围绕 基础概念与常识、基本语法、⭐️基本数据类型、变量、Java基础 等内容展开。结合 JavaGuide 知识体系梳理 Java / 基础。"
tags:
  - "clippings"
---
## 基础概念与常识
