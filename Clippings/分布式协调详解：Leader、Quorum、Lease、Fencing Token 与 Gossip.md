...
source: "https://javaguide.cn/distributed-system/protocol/centralized-and-decentralized.html"
author:
  - "[[Guide]]"
published: 2026-06-29
created: 2026-07-06
description: "分布式协调机制详解，讲解中心化与去中心化设计中的决策问题和状态传播问题，包括 Leader、Quorum、多数派、Term/Epoch、Lease、Fencing Token、Gossip、幂等和定时任务执行语义。重点围绕 这篇和其他文章是什么关系？、分布式系统为什么要协调？、Leader/Quorum 协调：谁来作。"
tags:
  - "clippings"
---
...
这篇文章只讨论设计取舍，不展开 ZooKeeper、etcd、Redis Cluster、Eureka 等具体系统的完整实现。想看共识算法，可以继续读 [Raft 算法详解](https://javaguide.cn/distributed-system/protocol/raft-algorithm.html) 和 [ZAB 协议详解](https://javaguide.cn/distributed-system/protocol/zab.html) ；想看状态传播，可以继续读 [Gossip 协议详解](https://javaguide.cn/distributed-system/protocol/gossip-protocol.html) ；想看业务互斥，可以继续读 [分布式锁实现方案详解](https://javaguide.cn/distributed-system/distributed-lock-implementations.html) 。

## 这篇和其他文章是什么关系？

[分布式系统入门](https://javaguide.cn/distributed-system/distributed-system-intro.html) 解决的是“为什么单机系统拆成多节点后会变复杂”。 [CAP 定理与 BASE 理论详解](https://javaguide.cn/distributed-system/protocol/cap-and-base-theorem.html) 解决的是“分区发生时一致性和可用性怎么取舍”。Raft、Paxos、ZAB 解决的是“一组节点如何对某个值或日志顺序达成一致”。Gossip 解决的是“状态如何在大量节点之间传播并最终收敛”。
