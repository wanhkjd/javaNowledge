...
created: 2026-07-06
description: "讲解 Redis 做消息队列的三种方式：List、Pub/Sub、Stream。对比生产级 MQ 核心能力，详解 Redis 5.0 Stream 的消费者组、ACK 机制及与 Kafka/RabbitMQ 的适用场景对比。重点围绕 第一阶段：早期用 List 数据结构、第二阶段：引入 Pub/Sub（发布/订阅）模。"
tags:
  - "clippings"
---
