...
source: "https://javaguide.cn/database/redis/redis-data-structures-02.html"
author:
  - "[[Guide]]"
published: 2026-05-18
created: 2026-07-06
description: "详解Redis三种特殊数据类型Bitmap、HyperLogLog、GEO的使用方法和应用场景，包括签到统计、UV统计、附近的人等典型业务场景实现。重点围绕 Bitmap （位图）、HyperLogLog（基数统计）、Geospatial (地理位置)、总结、Redis 等内容展开。结合 JavaGuide 知识体系。"
tags:
  - "clippings"
---
