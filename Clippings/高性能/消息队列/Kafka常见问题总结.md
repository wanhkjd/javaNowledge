---
title: "Kafka常见问题总结"
source: "https://javaguide.cn/high-performance/message-queue/kafka-questions-01.html"
author:
  - "[[Guide]]"
published: 2026-06-17
created: 2026-07-06
description: "本文总结 Kafka 常见面试题与核心知识点，涵盖 Kafka 架构（Broker/Topic/Partition/Consumer Group）、高性能原理（零拷贝/顺序写/批量处理）、消息可靠性（ACK机制/ISR副本）、消息顺序性、Rebalance 机制、Kafka 与 RocketMQ 对比等等核心内容。"
tags:
  - "clippings"
---
## Kafka 基础
