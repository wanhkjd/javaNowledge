...
source: "https://javaguide.cn/java/basis/java-basic-questions-03.html"
author:
  - "[[Guide]]"
published: 2026-06-25
created: 2026-07-06
description: "Java高级特性面试题总结：深入讲解异常处理机制、泛型原理、反射应用、注解使用、SPI机制、序列化、IO流模型(BIO/NIO/AIO)、语法糖等核心知识点。重点围绕 异常、泛型、⭐️ 反射、代理、Java基础 等内容展开。结合 JavaGuide 知识体系梳理 Java / 基础知识 / Java Basic Qu。"
tags:
  - "clippings"
---
## 异常
