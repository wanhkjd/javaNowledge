---
title: "Docker 实战"
source: "https://javaguide.cn/tools/docker/docker-in-action.html"
author:
  - "[[Guide]]"
published: 2026-06-11
created: 2026-07-06
description: "通过实战理解 Docker 的镜像与容器管理，解决环境一致性与交付效率问题，提升开发测试部署的协同效率。重点围绕 Docker 介绍、Docker 的安装、Docker 中的几个概念、Docker 初体验、Docker 等内容展开。结合 JavaGuide 知识体系梳理 开发工具 / Docker / Docker 。"
tags:
  - "clippings"
---
## Docker 介绍

开始之前，先简单回顾一下 Docker。更完整的概念介绍可以看前一篇文章： [Docker 核心概念总结](https://javaguide.cn/tools/docker/docker-intro.html) 。
