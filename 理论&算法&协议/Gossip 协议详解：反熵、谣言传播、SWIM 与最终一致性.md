...
source: "https://javaguide.cn/distributed-system/protocol/gossip-protocol.html"
author:
  - "[[Guide]]"
published: 2026-06-25
created: 2026-07-06
description: "Gossip 协议详解，讲解去中心化信息传播模型、反熵、谣言传播、Push/Pull 模式、SWIM 协议、最终一致性，以及在 Redis Cluster、Cassandra 等系统中的应用。重点围绕 背景、Gossip 协议介绍、Gossip 协议应用、Gossip 协议传播模式、分布式协议与算法 等内容展开。"
tags:
  - "clippings"
---
## 背景
...
如果你还不清楚 Leader/Quorum 和 Gossip 分别适合解决什么问题，可以先看 [分布式协调详解](https://javaguide.cn/distributed-system/protocol/centralized-and-decentralized.html) 。这篇 Gossip 文章只展开“状态如何传播并最终收敛”，不负责解释 Leader 选举、脑裂和 Fencing Token 这类强协调问题。
...
> 熵的概念最早起源于 [物理学](https://zh.wikipedia.org/wiki/%E7%89%A9%E7%90%86%E5%AD%A6) ，用于度量一个热力学系统的混乱程度。熵最好理解为不确定性的量度而不是确定性的量度，因为越随机的信源的熵越大。
