...
created: 2026-07-06
description: "本文深入讲解数据库读写分离与分库分表的核心原理，涵盖主从复制机制、读写分离实现方案（代理/组件）、垂直分库分表与水平分库分表的区别、分片键选择、订单表分库分表以及分布式事务、分布式ID、跨库JOIN等常见问题。重点围绕 读写分离、分库分表、总结、写在最后 等内容展开。结合 JavaGuide 知识体系梳理 高性能 /。"
tags:
  - "clippings"
---
## 读写分离
