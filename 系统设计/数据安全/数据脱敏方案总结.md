---
title: "数据脱敏方案总结"
source: "https://javaguide.cn/system-design/security/data-desensitization.html"
author:
  - "[[Guide]]"
published: 2026-05-18
created: 2026-07-06
description: "数据脱敏方案详解，涵盖手机号、身份证、银行卡等敏感数据的脱敏规则及Hutool工具实现方法。重点围绕 什么是数据脱敏、常用脱敏工具、总结、参考、安全 等内容展开。结合 JavaGuide 知识体系梳理 系统设计 / 安全 / Data Desensitization.Html 的核心概念、实践方法等核心内容。"
tags:
  - "clippings"
---
